...
smoothly and is clamped to stay fully inside the viewport: near an edge it pins
in place while its content keeps tracking the cursor, so the magnified pixel
under the cursor stays under the cursor everywhere.
